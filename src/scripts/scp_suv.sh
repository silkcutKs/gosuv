...
# 更新配置
ssh root@${host_name} 'mkdir -p /usr/local/service/gosuv/res'
ssh root@${host_name} 'mkdir -p /usr/local/service/gosuv/templates'
...
# 更新improxy
ssh root@${host_name} "rm -rf /usr/local/service/gosuv/tool_gosuv"
scp tool_gosuv root@${host_name}:/usr/local/service/gosuv/tool_gosuv
